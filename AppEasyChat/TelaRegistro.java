...
public class TelaRegistro extends JFrame implements ActionListener {
    ...
    JPanel pn = new JPanel(new GridLayout(14, 1, 0, 10));
    ...
    JLabel l6 = new JLabel("FRASE DO PERFIL", SwingConstants.LEFT);
    JLabel l7 = new JLabel("* Obrigatorio", SwingConstants.LEFT);
        ...
        if(e.getSource().equals(b1)) {
            if(t1.getText().equals("") || t2.getText().equals("") || t3.getText().equals("") || 
                ...
                if(verifData(t2.getText())) {
                    ...
                    this.user = new Usuario(t1.getText(), t3.getText(), t2.getText(), t4.getText(), t6.getText());

                    con.criaUsuario(this.user);
                    
                    this.setVisible(false);
                    new TelaLogin(this.con);
                    this.dispose();
                } else {
    ...
    public TelaRegistro(Conexao con) {
        super("Registro");
        this.con = con;
